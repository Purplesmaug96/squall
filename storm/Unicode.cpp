...
// From https://gist.github.com/tommai78101/3631ed1f136b78238e85582f08bdc618
...
int SUniConvertUTF8to16(wchar_t* pBuffer, int nBufferCount, const char* szSrc, int nSrcCount, int* pOutLength, int a6) {
	utf8_to_utf16((unsigned char*)szSrc, nSrcCount, (char16_t*)pBuffer, nBufferCount);
	*pOutLength = nSrcCount;
	return 0;
}
