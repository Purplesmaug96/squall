...
BOOL STORMCDECL SDlgCheckTimers();
...
int STORMCDECL SDlgUpdateCursor();
void SDlgSetLocale();
void SDlgSetTimer();
void SDlgKillTimer();
...
void SErrRepFortNamedResourceLeak();
...
BOOL STORMCDECL SNetResetLatencyMeasurements();
void SNetSelectGame();
